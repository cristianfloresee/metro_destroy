...
export class CustomersListComponent implements OnInit {
	...
	updateStatusForCustomers() {
		const _title = 'Status has been updated for selected customers';
		const _updateMessage = 'Selected customers status have successfully been updated';
	...
	editCustomer(customer: CustomerModel) {
		let _saveMessage;
		if(customer.id > 0){
			_saveMessage = 'Customer has been updated';
		}
		else{
			_saveMessage = 'Customer has been created';
		}
